	...
	return (
		<div className="register-partner__container">
			<div className="register-partner__hero">
				<h1 className="register-partner__hero-title">Seja um parceiro Rocketcab</h1>
				<h2 className="register-partner__hero-subtitle ">
					Aumente o movimento do seu negócio e fidelize clientes através de descontos
					exclusivos.
				</h2>
				<img className="register-partner__hero-image" src={RegisterImage} alt="" />
			</div>
			...
			<div className="register-partner__items-container">
				...
				<div>
					<ul className="register-partner__items ">
						<li className="register-partner__items-sub">
							...
							<p>
								Extra safety and hygiene measures so that you can ride around the city
								as safely as ever.
							</p>
						</li>
						<li className="register-partner__items-sub">
						...
						<li className="register-partner__items-sub">
							...
							<p>
								...
								faucibus sollicitudin. Nam viverra felis.
							</p>
						</li>
					</ul>
				</div>
				<div className="register-partner__footer">
					...
					<h3 className="register-partner__footer-subtitle">
						Cadastre seu estabelecimento gratuitamente e aumente o movimento do seu
						negócio.
					</h3>
